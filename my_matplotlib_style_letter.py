...
rcParams["axes.labelsize"] = 11.0
rcParams["axes.titlesize"] = 9.0
...
dark2_color_cycle = ["#1b9e77", "#d95f02", "#7570b3", "#e7298a", "#66a61e", "#e6ab02"]
...
#     "-",
# ]
colors = dark2_color_cycle[: len(styles)]
...
rcParams["axes.prop_cycle"] = cycler("color", colors) + cycler("linestyle", styles)
